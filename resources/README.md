...
- [The Path to Real World FHE: Navigating the Ciphertext Space ](https://www.youtube.com/watch?v=Q3glyMsaWIE&t=47s) by **Shruthi Gorantala** on **March 28, 2023**
...
- [Estimating the Difficulty of Breaking Lattice-Based Cryptography](https://fhe.org/meetups/017-Estimating_the_Difficulty_of_Breaking_Lattice_Based_Cryptography) by **Martin Albrecht** on **Nov 22, 2022**
- [FHE based on the NTRU problem: challenges and new constructions](https://fhe.org/meetups/015-FHE_based_on_the_NTRU_problem) by	**Hilder Vitor Lima Pereira** on **Sept 27, 2022**
- [Homomorphic Large Precision Integers Using Concrete](https://fhe.org/meetups/014-homomorphic-Large-Precision-Integers-Using-Concrete) by **Jean-Baptiste Orfila** on **Jul 07, 2022**
- [Single-Trace Side-Channel Attack on SEAL Homomorphic Encryption Library](https://fhe.org/meetups/013-single-trace-side-channel-attack-on-seal-homomorphic-encryption-library) by **Furkan Aydin** on **April 28, 2022**
- [Verifiable Computation over Encrypted Data: SNARKs and more](https://fhe.org/meetups/012-verifiable-computation-over-encrypted-data-snarks-and-more) by **Anca Nitulescu** on **Mar 29, 2022**
- [An overview of Hybrid Homomorphic Encryption](https://fhe.org/meetups/010-an-overview-of-hybrid-homomorphic-encryption) by **Orel Cosseron and Clément Hoffmann** on **Jan 20, 2022**
- [Google's C++ to FHE compiler](https://fhe.org/meetups/005-google-c++-to-fhe-transpiler) **Shruthi Gorantala and Rob Springer** on **Aug 26, 2021**
- [Developer Tools & Compilers](https://fhe.org/meetups/004-fhe-development-tools) by **Alexander Viand** on **May 20, 2021**
...
- [Homomorphic Encryption from Learning with Errors: Conceptually-Simpler, Asymptotically-Faster, Attribute-Based](https://link.springer.com/chapter/10.1007/978-3-642-40041-4_5) by **Craig Gentry, Amit Sahai, and Brent Waters** in **2013**
- [On-the-Fly Multiparty Computation on the Cloud via Multikey Fully Homomorphic Encryption](https://eprint.iacr.org/2013/094) by **Adriana Lopez-Alt, Eran Tromer, and Vinod Vaikuntanathan** in **2013**
- [Somewhat Practical Fully Homomorphic Encryption](https://eprint.iacr.org/2012/144) by **Junfeng Fan and Frederik Vercauteren** in **2012**
